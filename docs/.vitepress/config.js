...
export default defineConfig({
  ...
  cleanUrls: true,
  rewrites: {
    'browser/01-渲染流水线：从HTML到像素.md': 'browser/rendering-pipeline.md',
    'browser/02-布局抖动的真相：Layout-Thrashing如何搞垮动画.md': 'browser/layout-thrashing.md',
    'browser/03-绘制与光栅化.md': 'browser/painting-rasterization.md',
    'performance/01-现代前端性能的底层链路：如何减少关键路径上的等待、阻塞与重复工作.md': 'performance/critical-path.md',
    'performance/02-渲染性能避坑指南.md': 'performance/rendering-pitfalls.md',
